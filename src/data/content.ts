...
export const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Our goal is to construct a new storey building on Plot 361 — large enough to safely and comfortably house 66 orphaned and vulnerable children. A place with space to sleep, to study, to eat, to grow — and a safe room for guests during any visits.",
  ...
  },
  {
    ...
    date: "July 2026",
    readTime: "3 min read",
    excerpt: "In front of our dormitory house stands a small wooden house with a hand-painted sign: POULTRY. Inside is one of the hardest-working projects on our compound.",
    image: "/images/poultry-house.jpg",
    body: [
      "If you stand in front of our dormitory house at Grace and Hope Children's Home, you will find a small wooden house with a hand-painted sign: POULTRY. It may not look like much from the outside — but inside is one of the hardest-working projects on our compound.",
